...
const SLASH_COMMANDS: { command: string; description: string }[] = [
  ...
  { command: "/model <p/m>", description: "Switch provider/model" },
  { command: "/model", description: "Show/switch model" },
  { command: "/compact", description: "Force context compaction" },
  { command: "/checkpoint", description: "Save manual checkpoint" },
  { command: "/restore", description: "Restore workspace from checkpoint" },
  { command: "/checkpoints", description: "List checkpoints" },
